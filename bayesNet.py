...
class Factor(object):
    ...
    def __getAssignmentsInOrder(self, assignmentDict):
        ...
        # print(variablesAndAssignments)
        # print(self.__variableOrders)
        # print(self.__variableOrders['D'])
        # print(sorted(variablesAndAssignments, key=lambda x: self.__variableOrders[x[0]]))
        variablesAndAssignments = sorted(variablesAndAssignments, \
                                         key=(lambda var : self.__variableOrders[var[0]]))
